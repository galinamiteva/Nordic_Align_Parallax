...
{
    /// <inheritdoc />
    public partial class InitNordicAlign : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "decimal(15,2)", precision: 15, scale: 2, nullable: false, defaultValue: 100m),
                    CourierId = table.Column<int>(type: "int", nullable: true),
                    RecepientId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderModelWarehouseModel", x => new { x.OrdersId, x.WarehousesId });
                    table.ForeignKey(
                        name: "FK_OrderModelWarehouseModel_Orders_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderModelWarehouseModel_Warehouses_WarehousesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderModelWarehouseModel_WarehousesId",
                table: "OrderModelWarehouseModel",
                column: "WarehousesId");
