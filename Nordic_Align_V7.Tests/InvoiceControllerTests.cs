...
//    {
//        // Arrange
//        var result = _controller.CreateInvoice("test@example.com", "INV-002", DateTime.UtcNow, "Company", "Street", "City", "Country", "1000", "State", "12345","" "Comment", new List<string> { "Item1" }, new List<decimal> { 0m }, new List<int> { 1 });
